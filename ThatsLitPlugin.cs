...
namespace ThatsLit
{
    ...
    public class ThatsLitPlugin : BaseUnityPlugin
    {
        ...
        private void BindConfigs()
        {
            ...
            DarknessImpactScale        = Config.Bind(category, "Darkness Impact Scale", 1f, new ConfigDescription("Scale how AI noticing players slower due to darkness.", new AcceptableValueRange<float>(0, 1.1f), new ConfigurationManagerAttributes() { Order                                           = 95 }));
            BrightnessImpactScale      = Config.Bind(category, "Brightness Impact Scale", 1f, new ConfigDescription("Scale how AI noticing players faster due to brightness.", new AcceptableValueRange<float>(0f, 1.1f), new ConfigurationManagerAttributes() { Order                                       = 94 }));
